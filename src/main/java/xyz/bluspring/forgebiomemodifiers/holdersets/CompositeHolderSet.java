...
public abstract class CompositeHolderSet<T> implements ICustomHolderSet<T>
{
    ...
    public boolean isHomogenous()
    {
        ...
        SerializationType firstType = HolderSets.getSerializationType(holderSets.get(0));
        ...
        {
            final SerializationType type = HolderSets.getSerializationType(holderSets.get(i));
